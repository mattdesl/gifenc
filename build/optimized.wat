(module
 ...
 (data (i32.const 1616) "\05\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1644) "\01\t\00\00\02\00\00\00A\00\00\00\02")
 ...
 (func $src/assembly/index/encode (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
